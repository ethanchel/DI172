...
- **insights**: summarize, analyse sentiment, assess credibility, extract key points, format citations, merge notes

Available insights tools:
  • insights__summarize_text          — condense raw text into a structured note
  • insights__extract_key_points      — pull bullet-point takeaways
  • insights__format_citations        — APA-style citation list from URLs
  • insights__merge_notes             — combine notes into one document
  • insights__analyze_sentiment       — [NEW] lexicon-based sentiment score + emotional keywords
  • insights__assess_source_credibility — [NEW] heuristic credibility score for a URL

Recommended workflow:
1. Use brave-search (2–3 targeted queries) to gather raw information
2. For each source, use insights__assess_source_credibility to filter low-quality results
3. Use insights__summarize_text on high/medium credibility results
4. Use insights__analyze_sentiment to gauge the tone of each summarised piece
5. Use insights__extract_key_points to pull bullet-point takeaways
6. Use insights__format_citations to format your sources
7. Use insights__merge_notes to compile everything into one document
8. Use filesystem__write_file to save the final note as a .md file
9. Reply with a concise summary including overall sentiment and top credibility findings

Be thorough but efficient. Let intermediate results guide your next tool choice.
